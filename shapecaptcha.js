...
var _methods = __webpack_require__(0);
...
var ShapeCaptchaClass = function () {
    function ShapeCaptchaClass(options) {
        ...
        try {
            for (var _iterator = Object.keys(_methods2.default)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var key = _step.value;

                this[key] = _methods2.default[key].bind(this);
            }
        } catch (err) {
            _didIteratorError = true;
            _iteratorError = err;
    ...
    _createClass(ShapeCaptchaClass, [{
        ...
        value: function setOptions(x, val) {
            ...
            var setOption = function setOption(k, v) {
                k = k.toString();
                if (_this.options.hasOwnProperty(k) && _typeof(_this.options[k]) === (typeof v === 'undefined' ? 'undefined' : _typeof(v))) {
                    _this.options[k] = v;
                }
            };
